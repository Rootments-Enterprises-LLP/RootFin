...
router.post('/signin', SignUp).post('/login', Login).post('/createPayment', CreatePayment).get('/Getpayment', GetPayment).post('/saveCashBank', CloseController).get('/getsaveCashBank', GetCloseController).get('/AdminColseView', GetAllCloseData)
