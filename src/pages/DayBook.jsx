...
// Sample JSON Data
const jsonData = [
    { date: "01-02-2025", Bank: 4000, Cash: 30000, BillValue: 400000 },
    { date: "01-02-2025", Bank: 4000, Cash: 25000, BillValue: 400000 },
    { date: "01-02-2025", Bank: 4000, Cash: 55000, BillValue: 400000 }
];
const DayBook = () => {
                    ...
                    <table className="rounded-md table-auto w-full border-collapse border border-gray-300">
                        ...
                        <tfoot>
                            <tr className="bg-white text-center font-semibold">
                                ...
                                <td className="border border-gray-300 px-4 py-2">{tableData.reduce((sum, item) => sum + item.Cash, 0)}</td>
                                <td className="border border-gray-300 px-4 py-2">{tableData.reduce((sum, item) => sum + item.Bank, 0)}</td>
