...
// Sample JSON Data
const jsonData = [
    { date: "01-02-2025", invoice: "17623536783", ModeofPayment: "Cash", customer: "John Doe", TransactionNumber: "57346745", total: 3000 },
    { date: "01-02-2025", invoice: "17623536784", ModeofPayment: "Bank", customer: "Alice Smith", TransactionNumber: "7564348", total: 3000 },
    { date: "01-02-2025", invoice: "17623536785", ModeofPayment: "Bank", customer: "Michael Lee", TransactionNumber: "7565445", total: 3000 }
];
...
const SecurityReturn = () => {
    ...
    return (
        ...
        //                     <th className="border border-gray-300 px-4 py-2">Security Amount</th>
        //                 </tr>
        //             </thead>
        //             <tbody>
        ...
        //                         <td className="border border-gray-300 px-4 py-2">{item.ModeofPayment}</td>
        //                         <td className="border border-gray-300 px-4 py-2">{item.TransactionNumber}</td>
